...
export default class NPCActorSheet extends BaseActorSheet {
  ...
  static PARTS = {
    header: {
      template: "systems/las-torres-malditas/templates/actors/npc-header.hbs"
    },
    sidebarCollapser: {
    ...
    sidebar: {
      container: { classes: ["main-content"], id: "main" },
      template: "systems/las-torres-malditas/templates/actors/npc-sidebar.hbs"
    },
    features: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/las-torres-malditas/templates/actors/tabs/actor-features.hbs",
    ...
    inventory: {
      ...
      templates: [
        ...
        "systems/las-torres-malditas/templates/inventory/encumbrance.hbs"
      ],
      scrollable: [""]
    },
    spells: {
    ...
    biography: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/las-torres-malditas/templates/actors/tabs/npc-biography.hbs",
      scrollable: [""]
    },
    specialTraits: {
      classes: ["flexcol"],
