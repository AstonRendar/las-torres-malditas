...
export default class ItemGrantConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...super.PARTS,
    details: {
      template: "systems/las-torres-malditas/templates/advancement/item-grant-config-details.hbs"
    },
    spellConfig: {
      template: "systems/las-torres-malditas/templates/advancement/advancement-spell-config-section.hbs"
    },
    items: {
      template: "systems/las-torres-malditas/templates/advancement/item-grant-config-items.hbs"
    }
  };
