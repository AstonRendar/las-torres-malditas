...
function _generateLinks() {
  ...
  links.innerHTML = `
    <li>
      <a href="https://github.com/AstonRendar/las-torres-malditas/releases/latest" target="_blank">
        ${game.i18n.localize("DND5E.Notes")}
      </a>
    </li>
    <li>
      <a href="https://github.com/AstonRendar/las-torres-malditas/issues" target="_blank">${game.i18n.localize("DND5E.Issues")}</a>
    </li>
    <li>
      <a href="https://github.com/AstonRendar/las-torres-malditas/wiki" target="_blank">${game.i18n.localize("DND5E.Wiki")}</a>
    </li>
    <li>
...
export function renderSettings(html) {
  ...
  section.innerHTML = `
    ...
    <div class="system-badge">
      <img src="systems/las-torres-malditas/ui/official/dnd-badge-32.webp" data-tooltip="${dnd5e.title}" alt="${dnd5e.title}">
