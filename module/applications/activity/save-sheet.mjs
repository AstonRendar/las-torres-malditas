...
export default class SaveSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/las-torres-malditas/templates/activity/save-effect.hbs",
      templates: [
        ...
        "systems/las-torres-malditas/templates/activity/parts/save-damage.hbs",
        "systems/las-torres-malditas/templates/activity/parts/save-details.hbs",
        "systems/las-torres-malditas/templates/activity/parts/save-effect-settings.hbs"
      ]
    }
  };
  ...
  _prepareAppliedEffectContext(context, effect) {
    effect.additionalSettings = "systems/las-torres-malditas/templates/activity/parts/save-effect-settings.hbs";
    return effect;
  }
