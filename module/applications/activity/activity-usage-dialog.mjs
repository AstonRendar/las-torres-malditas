...
export default class ActivityUsageDialog extends Dialog5e {
  ...
  static PARTS = {
    scaling: {
      template: "systems/las-torres-malditas/templates/activity/activity-usage-scaling.hbs"
    },
    concentration: {
      template: "systems/las-torres-malditas/templates/activity/activity-usage-concentration.hbs"
    },
    consumption: {
      template: "systems/las-torres-malditas/templates/activity/activity-usage-consumption.hbs"
    },
    creation: {
      template: "systems/las-torres-malditas/templates/activity/activity-usage-creation.hbs"
    },
    footer: {
