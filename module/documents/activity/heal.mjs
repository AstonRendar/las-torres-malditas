...
export default class HealActivity extends ActivityMixin(HealActivityData) {
  ...
  static metadata = Object.freeze(
    foundry.utils.mergeObject(super.metadata, {
      type: "heal",
      img: "systems/las-torres-malditas/icons/svg/activity/heal.svg",
  ...
  _usageChatButtons(message) {
    ...
    return [{
      ...
      icon: '<i class="dnd5e-icon" data-src="systems/las-torres-malditas/icons/svg/damage/healing.svg"></i>',
      dataset: {
        action: "rollHealing"
      }
